...
$sql3="SELECT * FROM degree WHERE DName ="."'".$sure->mylist."'";
 ...
 -->      <div class="container">
  ...
  <!--  --><!-- <div class="form-row"> -->
       <div class="dropdown">
		...
		<?php
		while($rec = mysqli_fetch_array($result21))
		{
   ...
   <?php
  		$sql1="SELECT * from course";
			...
			while($rec = mysqli_fetch_array($result1)){?>
				<input type="checkbox" name="education[]" value="<?php echo $rec['Id']?>"><?php echo $rec['Name'];}?>
